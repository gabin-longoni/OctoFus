package com.ankamagames.dofus.network.messages.authorized
{
   ...
   public class ConsoleCommandsListMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      {
         var _val:String = String(input.readUTF());
