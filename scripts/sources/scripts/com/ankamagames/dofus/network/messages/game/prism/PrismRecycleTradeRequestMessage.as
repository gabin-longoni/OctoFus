package com.ankamagames.dofus.network.messages.game.prism
{
   ...
   public class PrismRecycleTradeRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_PrismRecycleTradeRequestMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_PrismRecycleTradeRequestMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_PrismRecycleTradeRequestMessage(tree:FuncTree) : void
      {
      }
   }
}
