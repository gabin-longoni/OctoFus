package com.ankamagames.dofus.network.messages.game.alliance
{
   ...
   public class AllianceRanksMessage extends NetworkMessage implements INetworkMessage
   {
      
      public static const protocolId:uint = 3971;
      ...
      public function AllianceRanksMessage()
      {
      ...
      public function initAllianceRanksMessage(ranks:Vector.<RankInformation> = null) : AllianceRanksMessage
      {
         this.ranks = ranks;
      ...
      public function serializeAs_AllianceRanksMessage(output:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_AllianceRanksMessage(input:ICustomDataInput) : void
      {
         var _item1:RankInformation = null;
         var _ranksLen:uint = uint(input.readUnsignedShort());
      ...
      public function deserializeAsyncAs_AllianceRanksMessage(tree:FuncTree) : void
      {
