package com.ankamagames.dofus.network.messages.game.startup
{
   ...
   public class ConsumeAllGameActionItemMessage extends NetworkMessage implements INetworkMessage
   {
      
      public static const protocolId:uint = 2381;
      ...
      public function ConsumeAllGameActionItemMessage()
      {
         super();
      }
      ...
      public function initConsumeAllGameActionItemMessage(characterId:Number = 0) : ConsumeAllGameActionItemMessage
      {
      ...
      public function serializeAs_ConsumeAllGameActionItemMessage(output:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_ConsumeAllGameActionItemMessage(input:ICustomDataInput) : void
      {
      ...
      public function deserializeAsyncAs_ConsumeAllGameActionItemMessage(tree:FuncTree) : void
      {
