package com.ankamagames.dofus.network.messages.game.character.alteration
{
   ...
   public class AlterationsUpdatedMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function AlterationsUpdatedMessage()
      {
      ...
      public function initAlterationsUpdatedMessage(alterations:Vector.<AlterationInfo> = null) : AlterationsUpdatedMessage
      {
      ...
      public function serializeAs_AlterationsUpdatedMessage(output:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_AlterationsUpdatedMessage(input:ICustomDataInput) : void
      {
         var _item1:AlterationInfo = null;
         var _alterationsLen:uint = uint(input.readUnsignedShort());
      ...
      public function deserializeAsyncAs_AlterationsUpdatedMessage(tree:FuncTree) : void
      {
      ...
      {
         var length:uint = uint(input.readUnsignedShort());
