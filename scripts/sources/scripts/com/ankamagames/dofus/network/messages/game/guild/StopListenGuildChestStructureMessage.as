package com.ankamagames.dofus.network.messages.game.guild
{
   ...
   public class StopListenGuildChestStructureMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_StopListenGuildChestStructureMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_StopListenGuildChestStructureMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_StopListenGuildChestStructureMessage(tree:FuncTree) : void
      {
      }
   }
}
