package com.ankamagames.dofus.network.messages.game.context.roleplay
{
   ...
   public class MapComplementaryInformationsDataMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public static const protocolId:uint = 6795;
      ...
      public function deserializeAs_MapComplementaryInformationsDataMessage(input:ICustomDataInput) : void
      {
         ...
         var _housesLen:uint = uint(input.readUnsignedShort());
         ...
         var _actorsLen:uint = uint(input.readUnsignedShort());
         ...
         var _interactiveElementsLen:uint = uint(input.readUnsignedShort());
         ...
         var _statedElementsLen:uint = uint(input.readUnsignedShort());
         ...
         var _obstaclesLen:uint = uint(input.readUnsignedShort());
         ...
         var _fightsLen:uint = uint(input.readUnsignedShort());
      ...
      {
         var _id:uint = uint(input.readUnsignedShort());
