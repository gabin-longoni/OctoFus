package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class FightStartingPositions implements INetworkType
   {
      ...
      public static const protocolId:uint = 9111;
      ...
      public function deserializeAs_FightStartingPositions(input:ICustomDataInput) : void
      {
         var _val1:uint = 0;
         var _val2:uint = 0;
         var _positionsForChallengersLen:uint = uint(input.readUnsignedShort());
         ...
         var _positionsForDefendersLen:uint = uint(input.readUnsignedShort());
