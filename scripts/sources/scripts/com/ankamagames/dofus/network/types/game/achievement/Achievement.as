package com.ankamagames.dofus.network.types.game.achievement
{
   ...
   public class Achievement implements INetworkType
   {
      ...
      public static const protocolId:uint = 3667;
      ...
      public function deserializeAs_Achievement(input:ICustomDataInput) : void
      {
         ...
         this._idFunc(input);
         var _finishedObjectiveLen:uint = uint(input.readUnsignedShort());
         ...
         var _startedObjectivesLen:uint = uint(input.readUnsignedShort());
