package com.ankamagames.dofus.datacenter.quest
{
   ...
   public class Achievement implements IDataCenter
   {
      ...
      {
         this.initCurrentLevelRewards(pPlayerLevel);
         return this._currentLevelRewards == null ? 0 : this._currentLevelRewards.getGuildPointsReward();
      }
      ...
      private function initCurrentLevelRewards(level:int) : void
      {
         ...
         if(Boolean(currentRewardsAll) && (!currentRewards || currentRewards.length < currentRewardsAll.length))
         {
