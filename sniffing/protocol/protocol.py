...
from sniffing.protocol.protocol_load import types, msg_from_id, types_from_id, primitives
from sniffing.data.binrw import Data, Buffer


logger = logging.getLogger("OctoFus-Protocol")
