package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class FightCommonInformations implements INetworkType
   {
      ...
      public static const protocolId:uint = 8687;
      ...
      public function deserializeAs_FightCommonInformations(input:ICustomDataInput) : void
      {
         ...
         var _fightTeamsLen:uint = uint(input.readUnsignedShort());
         ...
         var _fightTeamsPositionsLen:uint = uint(input.readUnsignedShort());
         ...
         var _fightTeamsOptionsLen:uint = uint(input.readUnsignedShort());
