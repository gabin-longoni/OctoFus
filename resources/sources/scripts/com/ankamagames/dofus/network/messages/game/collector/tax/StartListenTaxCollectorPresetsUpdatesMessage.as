package com.ankamagames.dofus.network.messages.game.collector.tax
{
   ...
   public class StartListenTaxCollectorPresetsUpdatesMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_StartListenTaxCollectorPresetsUpdatesMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_StartListenTaxCollectorPresetsUpdatesMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_StartListenTaxCollectorPresetsUpdatesMessage(tree:FuncTree) : void
      {
      }
   }
}
