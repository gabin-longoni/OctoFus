package com.ankamagames.dofus.network.messages.game.context.roleplay.quest
{
   ...
   public class QuestListMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function deserializeAs_QuestListMessage(input:ICustomDataInput) : void
      {
         ...
         var _val4:uint = 0;
         var _finishedQuestsIdsLen:uint = uint(input.readUnsignedShort());
         ...
         var _finishedQuestsCountsLen:uint = uint(input.readUnsignedShort());
         ...
         var _activeQuestsLen:uint = uint(input.readUnsignedShort());
         ...
         var _reinitDoneQuestsIdsLen:uint = uint(input.readUnsignedShort());
