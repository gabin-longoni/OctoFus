package com.ankamagames.dofus.network.messages.game.nuggets
{
   ...
   public class StopListenNuggetsMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_StopListenNuggetsMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_StopListenNuggetsMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_StopListenNuggetsMessage(tree:FuncTree) : void
      {
      }
   }
}
