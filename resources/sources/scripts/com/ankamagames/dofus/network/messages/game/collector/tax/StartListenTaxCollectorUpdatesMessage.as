package com.ankamagames.dofus.network.messages.game.collector.tax
{
   ...
   public class StartListenTaxCollectorUpdatesMessage extends NetworkMessage implements INetworkMessage
   {
      
      public static const protocolId:uint = 4786;
      ...
      public function StartListenTaxCollectorUpdatesMessage()
      {
         super();
      }
      ...
      public function initStartListenTaxCollectorUpdatesMessage(taxCollectorId:Number = 0) : StartListenTaxCollectorUpdatesMessage
      {
      ...
      public function serializeAs_StartListenTaxCollectorUpdatesMessage(output:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_StartListenTaxCollectorUpdatesMessage(input:ICustomDataInput) : void
      {
      ...
      public function deserializeAsyncAs_StartListenTaxCollectorUpdatesMessage(tree:FuncTree) : void
      {
