package com.ankamagames.dofus.network.messages.game.surrender.vote
{
   ...
   public class OpponentSurrenderMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_OpponentSurrenderMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_OpponentSurrenderMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_OpponentSurrenderMessage(tree:FuncTree) : void
      {
      }
   }
}
