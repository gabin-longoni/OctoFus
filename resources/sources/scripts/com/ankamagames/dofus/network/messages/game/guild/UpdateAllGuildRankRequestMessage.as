package com.ankamagames.dofus.network.messages.game.guild
{
   ...
   public class UpdateAllGuildRankRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public static const protocolId:uint = 4316;
      ...
      public function serializeAs_UpdateAllGuildRankRequestMessage(output:ICustomDataOutput) : void
      {
      ...
      public function deserializeAsyncAs_UpdateAllGuildRankRequestMessage(tree:FuncTree) : void
      {
