package com.ankamagames.dofus.datacenter.effects
{
   ...
   public class EffectInstance implements IDataCenter
   {
      ...
      public function get useInFight() : Boolean
      {
         ...
         return Boolean(this._effectData) && this._effectData.useInFight;
      }
      ...
      public function get priority() : uint
      {
         if(this._priority == 0)
         {
            ...
            this._priority = !!this._effectData ? this._effectData.effectPriority : 0;
         }
         ...
         if(desc.indexOf("#") != -1)
         {
            ...
            switch(effectId)
            {
               ...
               case ActionIds.ACTION_CHARACTER_REFLECTOR_UNBOOSTED:
                  if(!aTmp[0] && !aTmp[1] && Boolean(aTmp[2]))
                  {
                     aTmp[0] = aTmp[2];
                  }
                  aTmp[5] = "m";
               ...
               case ActionIdProtocol.ACTION_ITEM_EXPIRATION:
                  ...
                  nYear = String(aTmp[0]);
                  nMonth = String(aTmp[1].substr(0,2));
                  nDay = String(aTmp[1].substr(2,2));
                  nHours = String(aTmp[2].substr(0,2));
                  nMinutes = String(aTmp[2].substr(2,2));
               ...
               case ActionIds.ACTION_CHARACTER_GAIN_XP_WO_BOOST:
                  level = uint(aTmp[1]);
                  remainingXpPercentage = uint(aTmp[2]);
               ...
               case ActionIds.ACTION_ITEM_CUSTOM_EFFECT:
                  ...
                  {
                     case 0:
                        text = String(aTmp[0].replace(aTmp[0],"<span class=\'bonus\'>" + aTmp[0]));
                        break;
                     case 1:
                        text = String(aTmp[0].replace(aTmp[0],"<span class=\'malus\'>" + aTmp[0]));
                        break;
                     case 2:
                        text = String(aTmp[0].replace(aTmp[0],"<span class=\'neutral\'>" + aTmp[0]));
                        break;
                     case 3:
                        text = String(aTmp[0].replace(aTmp[0],"<span class=\'exotic\'>" + aTmp[0]));
                  }
                  aTmp[1] = null;
                  aTmp[0] = text + "</span>";
                  break;
